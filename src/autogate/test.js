...
var openLeftGate = function openLeftGate() {
    return { type: BUTTON.LEFT, gateStatus: 'LEFT GATE OPENED' };
};

var openRightGate = function openRightGate() {
...
// reducers
var autogate = function autogate() {
...
// createStore
var Gate = (0, _redux.createStore)(autogate);

// gate object
var gateObj = function gateObj(gateStatus, activeButton) {
    var state = void 0;
